...
namespace Byway.Api.Migrations
{
    ...
    [Migration("20250930065750_RenameThumbnailBase64ToThumbnailPath")]
    partial class RenameThumbnailBase64ToThumbnailPath
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Byway.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            LastName = "User",
                            PasswordHash = "$2a$11$0OLx8aV100UT8jNFaqPO6e58R9ha5Xsuk34pYP0t9vF5vMY/aShPC",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            ...
                            IsAdmin = false,
                            LastName = "Doe",
                            PasswordHash = "$2a$11$88JM/LL2Q/5O6ekyUNTf0.2z7XRxKMMPQkuN0VDrQ501Yga.fozZW",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });
